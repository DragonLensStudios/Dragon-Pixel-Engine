...
| --- | --- | --- | --- |
| Strict Release | Current post-atomic-repair feature branch passes 56/56 in 423.22 s; full build passes in 105.81 s | Current expanded run required | Current post-0008 run required |
| Native AddressSanitizer | Current post-atomic-repair feature branch passes 56/56 in 560.43 s; full build passes in 64.31 s | Current expanded run required | Current post-0008 run required |
