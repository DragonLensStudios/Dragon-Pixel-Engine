...
> **Governing architecture:** `DPE-ARCH-0013`
...
| --- | --- | --- | --- |
| Strict Release | Last complete pre-DPE-ARCH-0010 baseline 45/45; focused DPE-ARCH-0010 editor/runtime/generator aliases pass; new authoritative full run waits on atomic-publication repair | Current expanded run required | Current post-0008 run required |
| Native AddressSanitizer | Last complete pre-DPE-ARCH-0010 baseline 45/45 in 368.80 s; focused DPE-ARCH-0010 editor/runtime/generator aliases pass | Current expanded run required | Current post-0008 run required |
