...
Current evidence (2026-07-25): Windows and Ubuntu now pass metadata version 3 in addition to UUID type identities, generated managed/native manifests, stable-ID rename and migration, headless inspection, opaque preservation, descriptor defaults/ranges/steps/units/enums/reference filters, typed Inspector validation, component actions, mixed multi-edit, and current POC H public-interaction coverage. The full matrices pass on Windows Release (36/36 in 118.39 seconds), Windows MSVC AddressSanitizer (36/36 in 134.93 seconds), Ubuntu Release (36/36 in 102.20 seconds), and Ubuntu Clang AddressSanitizer (36/36 in 101.97 seconds).
