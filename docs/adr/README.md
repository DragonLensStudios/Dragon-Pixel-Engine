...
The current post-atomic-repair feature branch passes all **56/56 Windows 11 x64 strict Release tests in 423.22 seconds** and **56/56 MSVC AddressSanitizer tests in 560.43 seconds**. Final `s1.native_core` stability also passes 100/100 Release and 50/50 sanitizer repetitions. The formerly inconclusive aggregate sanitizer interaction aliases pass in 181.13 and 179.14 seconds under unchanged 480-second caps, clearing the recorded Windows full-matrix blocker on this branch. Focused DPE-ARCH-0010 through DPE-ARCH-0014 editor/runtime/input/project/asset/Hierarchy/multi-Inspector evidence and the refreshed 188-record production-style bundle remain green. Ubuntu 24.04 x64's latest pre-DPE-ARCH-0008 matrices remain Release 36/36 in 102.20 seconds and Clang AddressSanitizer 36/36 in 101.97 seconds; the repaired POSIX publication paths have no current Ubuntu/macOS execution evidence. The available macOS arm64 evidence remains the earlier 14-of-15 result with the unchanged POC B 1280×720/30 FPS gate failing. Physical-gamepad/hot-plug proof, complete aggregate POC J acceptance, current Ubuntu/macOS expanded evidence, single-preview-worker simultaneous output, accessibility/compliance review, and POCs M-S remain open. All ADRs remain `Proposed`; this Windows-only evidence promotes none of them, and ADR-0006's handle-pinning/noncooperating-writer limits remain explicit.
