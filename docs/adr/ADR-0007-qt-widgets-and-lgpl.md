...
Current evidence (2026-07-25): the Qt shell, stable docks, model-backed Hierarchy/Project Explorer/Inspector/Console foundations, typed editing and validation, public-action command flows, workspace persistence, shared real-frame integration, and current POC H automated interaction suite pass on Windows and Ubuntu. The full matrices pass on Windows Release (36/36 in 118.39 seconds), Windows MSVC AddressSanitizer (36/36 in 134.93 seconds), Ubuntu Release (36/36 in 102.20 seconds), and Ubuntu Clang AddressSanitizer (36/36 in 101.97 seconds). A Windows manual walkthrough also passed the current launch, authoring, viewport, save/reopen, and runtime controls.
