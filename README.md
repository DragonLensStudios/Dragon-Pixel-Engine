...
> **About this main-branch page:** The documentation was merged through [PR #8](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/pull/8) into `feature/project-view-workflow`. This page is published to `main` separately at the owner's request; the engine implementation described here remains on the development branches. Source and documentation links below point to the reviewed documentation snapshot, so they remain usable from main. PR #7 and its product acceptance gates are still open.
...
The [Design Document](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Dragon%20Pixel%20Engine%20Design%20Document.md) defines exact contracts, tradeoffs, risks, and gates. Its future requirements are not a list of finished features.
...
These contract versions are not stable-release certification. [Schemas](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/schemas), [native sources](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/native), and the [ADR index](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/adr/README.md) provide details. Broader migration/plugin/build/update/support-bundle contracts in the design remain partly or wholly planned.
...
Read the [managed contracts](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/managed/DragonPixel.Contracts/RuntimeComponents.cs) and [native ABI](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/native/CAbi/include/dragonpixel/cabi/component_plugin_v1.h). Script transforms affect disposable rendering/picking and never saved scenes. Managed render overrides are not a general physics-body control API; native transform-control parity remains open.
...
Linked prefabs keep source revisions, instance mappings, normalized overrides, and fallback content distinct from locally owned records. Instantiate, Apply, Revert, Repair/Rebase, Unpack, and Unpack Completely use commands and recoverable publication. Missing/newer sources preserve fallbacks; cycle/depth/entity guards prevent unsafe expansion. Complete designer/recovery matrices remain open; see [prefab evidence](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Prototypes/POC%20F%20Linked%20Nested%20Prefab%20Evidence.md).

## Development workflow

Feature work starts from current `develop`, uses one focused `feature/*` branch and a mirrored living plan, proceeds through small tested commits, and ends with aggregate diff review plus a draft pull request into `develop`. Multiple independent feature PRs may remain open and be reviewed manually at the same time. A genuinely dependent child may temporarily target one parent `feature/*` branch only when both plans and PR bodies identify the dependency, ownership, overlap, merge order, and retarget steps; the child cannot merge first and must be updated, retargeted to current `develop`, re-reviewed, and retested after its parent merges. Codex and contributors must read [AGENTS.md](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/AGENTS.md) and the [Development Constitution](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Development/Development%20Constitution.md); the reusable [feature-plan template](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Development/Feature%20Plan%20Template.md), [GitFlow handbook](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Development/GitFlow%20Handbook.md), [verification checklist](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Development/Verification%20Checklist.md), and [feature PR template](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/.github/PULL_REQUEST_TEMPLATE/feature.md) define the handoff.
...
To inspect this baseline and inherited unmerged Project Window work, fetch and check out `feature/project-view-workflow` (documentation merged through PR #8). `main` is reserved for releases and does not contain all development features.
...
| --- | --- | --- |
| Native build | C++20, CMake 3.25 minimum, Ninja Multi-Config | [CMakeLists](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/CMakeLists.txt), [presets](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/CMakePresets.json) |
| Windows / Qt | MSVC v143, Qt 6.11.1 MSVC 2022 x64 | [prerequisite installer](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/scripts/dev/Install-WindowsPrerequisites.ps1) |
| Managed SDK/language | .NET SDK 10.0.203 with latest-patch roll-forward, C# 14 | [global.json](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/global.json), [properties](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/Directory.Build.props) |
| Portable contracts | .NET Standard 2.1 | [contracts project](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/managed/DragonPixel.Contracts/DragonPixel.Contracts.csproj) |
| MonoGame DesktopGL | 3.8.5 | [worker project](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/managed/DragonPixel.Adapter.MonoGame.Worker/DragonPixel.Adapter.MonoGame.Worker.csproj) |
| Experimental KNI SDL2 GL | 4.2.9001.1 | [worker project](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/managed/DragonPixel.Adapter.Kni.Worker/DragonPixel.Adapter.Kni.Worker.csproj) |
| Native libraries | Box2D 3.1.1, Jolt 5.6.0, SDL3, nlohmann-json through pinned vcpkg | [manifest](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/vcpkg.json) |
...
The importer accepts finite numeric arrays or infinite numeric chunks, multiple inline or external JSON atlas TileSets, orthogonal, isometric, staggered, and hexagonal orientations, tile animation, and conservatively representable terrain/Wang rules. Layer order, names, visibility, negative coordinates, and Tiled GID transformations are preserved. TMX/TSX XML, encoded or compressed layers, object/image/group layers, image collections, unsupported Wang semantics, and reimport remain rejected before publication. See the [Tiled import feature plan](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Plans/Dragon%20Pixel%20Engine%20Tiled%20Tilemap%20Import%20Plan.md) for historical PR #5 evidence and the parity follow-up disposition.
...
For native Unix development, configure Qt/.NET/vcpkg/compiler prerequisites from the [cross-platform workflow](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/.github/workflows/slice1.yml), set `VCPKG_ROOT`, and expose Qt through `CMAKE_PREFIX_PATH`. Then:
...
The [Slices 1-4 plan](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Plans/Dragon%20Pixel%20Engine%20Slices%201-4%20Version%201.0%20Completion%20Plan.md) owns delivery tracking. Later implementation does not waive earlier acceptance failures.
...
| Location | Contents |
| --- | --- |
| [src/native](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/native) | Core, scenes/commands, metadata, serialization/recovery, prefab, tiles, physics, C ABI and tests |
| [src/editor](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/editor) | Qt shell, services/models, panels, workflows and public interaction tests |
| [src/managed](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/managed) | Contracts, interop, adapter host/workers and managed tests |
| [src/importers](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/src/importers), [pocs](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/pocs) | Isolated importers and architecture/conformance probes |
| [schemas](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/schemas), [templates](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/templates), [samples](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/samples) | Versioned contracts, declarative projects and reference data |
| [tools/python](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/tools/python) | External automation client and protocol tests |
| [scripts/dev](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/scripts/dev), [scripts/ci](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/scripts/ci), [scripts/docs](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/scripts/docs) | Builds/launchers, CI/container checks and mirror validation |
| [docs/adr](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/adr), [docs/Prototypes](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Prototypes), [docs/Milestones](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Milestones), [docs/Plans](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Plans) | Decisions, dated evidence, acceptance audits and plans |
| [docs/Compliance](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Compliance), [prompts](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/tree/edff7a8bb6e36d79d8c041790f3e7e011868040d/prompts) | Licensing obligations and operational development prompts |

Start with these records:

- [Design Document](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Dragon%20Pixel%20Engine%20Design%20Document.md): architecture, boundaries, risks, POCs and acceptance criteria.
- [LLM Prompt Source — 0.1.0](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Dragon%20Pixel%20Engine%20LLM%20Prompt%20Source.md): original prompt, consolidated result, subsequent prompts/results, research and complete retained architecture history.
- [Original first-structure prompt](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Dragon%20Pixel%20Engine%20First%20Structure%20Prompt%20Main%20Flow.md): immutable historical source.
- [Detailed 1.0 product summary](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Dragon%20Pixel%20Engine%201.0%20%E2%80%94%20Detailed%20Product%20Summary.md): target vision; use dated plans for completion status.
- [0.1.0 baseline plan](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Plans/Dragon%20Pixel%20Engine%200.1.0%20Documentation%20Baseline%20Plan.md): preservation checks, licensing decision, verification and Git handoff.
...
Use [issues](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/issues) and [pull requests](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/pulls) for bounded work and reproducible reports with platform/adapter details. The [sustainability guide](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Development/Open%20Source%20and%20Commercial%20Sustainability.md) describes services, expertise, training, and sponsorship supporting an open-source core.

## License and dependencies

Dragon Pixel's own code remains **[MIT licensed](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/LICENSE.md)**, copyright 2026 Monydragon, as confirmed by the owner for this baseline. MIT permits commercial use, modification, and redistribution subject to retaining its notice; it provides no warranty. [MIT text](https://opensource.org/license/mit).
...
See the [MIT/dependency compatibility record](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Compliance/Dragon%20Pixel%20Engine%20MIT%20and%20Dependency%20Compatibility.md), [Qt inventory](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Compliance/Qt%206.11.1%20LGPL%20Deployment%20Inventory.md), and [physics inventory](https://github.com/DragonLensStudios/Dragon-Pixel-Engine/blob/edff7a8bb6e36d79d8c041790f3e7e011868040d/docs/Compliance/Box2D%203.1.1%20and%20Jolt%20Physics%205.6.0%20Dependency%20and%20License%20Inventory.md). Primary licensing sources were checked on 2026-09-18; this documentation is not a completed package/license audit.
