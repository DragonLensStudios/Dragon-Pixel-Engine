...
private:
    ...
    void navigate_project_browser_to(const QString& logical_path, bool record_history = true);
    void rebuild_project_breadcrumb();
    void update_project_navigation_actions();
    [[nodiscard]] QModelIndex find_project_source(int role, const QString& value) const;
    void update_project_details(const QModelIndex& proxy_index);
    [[nodiscard]] QString current_project_folder_relative() const;
    [[nodiscard]] QModelIndex current_project_content_index() const;
    void rebuild_project_favorites();
    void add_project_favorite(const QString& kind, const QString& value);
    void activate_project_favorite(const QModelIndex& index);
    void save_project_search();
    void set_project_two_column(bool enabled);
    void set_project_icon_size(int size);
    void frame_project_selection();
    void rename_selected_project_asset();
    void duplicate_selected_project_asset();
    void trash_selected_project_asset(bool confirm);
    ...
    QListView* project_favorites_{};
    QStandardItemModel* project_favorites_model_{};
    QListView* project_thumbnail_view_{};
    QStackedWidget* project_content_stack_{};
    QWidget* project_bottom_bar_{};
    QSlider* project_icon_size_{};
    QAction* project_one_column_action_{};
    QAction* project_two_column_action_{};
    QToolButton* project_lock_{};
    QToolButton* project_back_{};
    QToolButton* project_forward_{};
    QToolButton* project_up_{};
    QLabel* project_breadcrumb_{};
    QWidget* project_breadcrumb_segments_{};
    QSplitter* project_splitter_{};
    QLabel* project_details_{};
    QPersistentModelIndex project_current_folder_;
    QStringList project_folder_history_;
    int project_folder_history_index_{-1};
    bool project_navigation_replay_{};
    bool project_browser_locked_{};
